#!/usr/bin/env bash
#
# install.sh — Install Yeshivish spinner verbs into Claude Code.
# macOS / Linux. Requires: bash, curl, jq.
#
set -euo pipefail

# --- config ---
REPO_RAW_URL="https://raw.githubusercontent.com/ElimelekhPerl/yeshivish-spinner/refs/heads/master/spinner-verbs.json"
